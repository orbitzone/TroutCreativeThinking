					...
					<div class="shots row-fluid">
						<div id="homeCarousel" class="carousel slide">
							<div class="carousel-inner">
								...
								<div class="item"> <img src="/assets/images/the-block-skyhigh/placeholder-home-carousel-1.jpg" border="0" /> </div>
								<div class="item"> <img src="/assets/images/the-block-skyhigh/placeholder-home-carousel-2.jpg" border="0" /> </div>
							</div>
							<a class="carousel-control left" href="#homeCarousel" data-slide="prev">&lsaquo;</a> <a class="carousel-control right" href="#homeCarousel" data-slide="next">&rsaquo;</a> </div>
					</div>
					<div class="row-fluid top-space promos">
						<div class="span4">
							<div class="promo"> <a href="http://www.reece.com.au/bathroom-inspiration/trends/day-spa">
								<div id="myCarousel" class="carousel slide">
									<div class="carousel-inner">
										<div class="item active"> <img src="/assets/images/the-block-skyhigh/promo-shaynna.jpg" alt=""> </div>
										<div class="item"> <img src="/assets/images/the-block-skyhigh/promo-shaynna1.jpg" alt=""> </div>
										<div class="item"> <img src="/assets/images/the-block-skyhigh/promo-shaynna2.jpg" alt=""> </div>
									</div>
