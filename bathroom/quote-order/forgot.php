							...
							<div class="row-fluid">
								...
								<div class="span5 offset1">
									...
									<div class="retailQuoteForm">
										<h4 class="retailQuoteRedHeader">Forgot Your Password</h4>
										<p class="retailQuoteMessage">Please enter your email address and we’ll send you instructions to reset your password.</p>
										<div class="controls">
										<input placeholder="Email Address" type="email">
										</div>
										<button class="retailQuoteRedBtn pull-right">Submit</button>
									</div>
								</div>
							</div>
