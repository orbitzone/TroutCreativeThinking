	  ...
	  <path d="M1644.29,629.674a1.048,1.048,0,0,0-1.12,1.107v4.43a1.047,1.047,0,0,0,1.12,1.1h4.48a1.052,1.052,0,0,0,1.12-1.1v-4.43a1.053,1.053,0,0,0-1.12-1.107h-4.48Zm12.31,0v6.641h58.23v-6.641H1656.6Zm-12.31,15.5a1.048,1.048,0,0,0-1.12,1.107v4.429a1.048,1.048,0,0,0,1.12,1.106h4.48a1.053,1.053,0,0,0,1.12-1.106V646.28a1.053,1.053,0,0,0-1.12-1.107h-4.48Zm12.31,0v6.642h44.8v-6.642h-44.8Zm-12.31,15.5a1.048,1.048,0,0,0-1.12,1.107v4.427a1.049,1.049,0,0,0,1.12,1.109h4.48a1.054,1.054,0,0,0,1.12-1.109v-4.427a1.053,1.053,0,0,0-1.12-1.107h-4.48Zm12.31,0v6.643h58.23v-6.643H1656.6Zm-12.31,15.5a1.046,1.046,0,0,0-1.12,1.1v4.43a1.048,1.048,0,0,0,1.12,1.107h4.48a1.053,1.053,0,0,0,1.12-1.107v-4.43a1.052,1.052,0,0,0-1.12-1.1h-4.48Zm12.31,0v6.642h53.75v-6.642H1656.6Z" transform="translate(-1643.16 -629.688)"/>
								...
								<div class="product-icons">
									<div class="row">
										...
										<div class="col-xs-6">
											<div class="item">
													<img src="templates/images/product-detail/promo.jpg" alt="Promo"/>
													<span>PROMO</span>											
											</div>
										</div>
									</div>
					...
					<div class="row">
						<div class="col-xs-12">
							<ul class="list-inline">
								<li>
									<div class="icon">
										<img class="img-responsive" src="templates/images/product-detail/icon-target.png" alt="item">
									</div>
									<div class="text">
								...
								<li>
									<div class="icon">
										<img class="img-responsive" src="templates/images/product-detail/icon-bulb.png" alt="item">
									</div>
									<div class="text">
										Lorem ipsum doilor sit amet
									</div>
								...
								<li>
									<div class="icon">
										<img class="img-responsive" src="templates/images/product-detail/icon-disc.png" alt="item">
									</div>
									<div class="text">
										Lorem ipsum doilor sit amet
									</div>
								...
								<li>
									<div class="icon">
										<img class="img-responsive" src="templates/images/product-detail/icon-diamond.png" alt="item">
									</div>
									<div class="text">
										Lorem ipsum doilor sit amet
									</div>
								...
								<li>
									<div class="icon">
										<img class="img-responsive" src="templates/images/product-detail/icon-dna.png" alt="item">
									</div>
									<div class="text">
										Lorem ipsum doilor sit amet
									</div>
						...
						<div class="col-sm-6">
							<div class="story">
								<div class="row">
									<div class="col-xs-5">
										<div class="image">
											<img src="templates/images/product-detail/powder-room-image.jpg" alt="Story 1">
										</div>
									</div>
									<div class="col-xs-7">
										<h4>Headline</h4>
			...
			<div class="container-fluid section-container">
				<div class="section-content no-border">
					<div class="row">
						<div class="col-sm-5">
							<div class="inner-wrap">
								<img class="img-responsive" src="templates/images/product-detail/learn-more-about-milli.jpg" alt="banner">
							</div>
						</div>
						<div class="col-sm-7">
							<div class="inner-wrap">
