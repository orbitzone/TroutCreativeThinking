	...
	<?php 
		$cssScriptPaths = [
			...
			"/assets/css/reece-onsite.css"
		]; 
	   	include_once($serverBase."/includes/head/head-generic.php");
	?>		

    <body class="no-touch bathroom-moments account-details-summary withSubNav irrigationPage">
		<div class="ocmain-wrapper">
			<div class="navbar navbar-fixed-top topNav">
			<?php 
				$genericNavActiveMenuItem = "Onsite";
			...
			<div class="inner-wrapper">
				...
				<div class="article-banner-trade page-branding box-brand clearfix">
					<div class="banner-branding-block page-branding box-brand pull-left">
						<h3 class="banner-branding-title">onsite</h3>
					</div>
					<p class="article-banner-description">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus mollis id est a facilisis. Praesent pellentesque erat eget enim convallis porta.</p>
