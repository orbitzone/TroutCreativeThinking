                            ...
                            <footer class="item-footer">
                                <div class="info-state">
                                    <span class="quantity left-col">
                                        <span class="number"><?php echo $quantity; ?></span> <span class="set">Pkt</span>
                                    </span>
                                    <span class="price right-col">
                                        $<?php echo $quantity * $product['price'];?>
                                    </span>
                                    <div class="clear-fix"></div>
                                </div>
                                <div class="edit-state">
                                        ...
                                        <div class="quantity-wrap">
                                            ...
                                            <div class="quantity-set">
                                                <span class="radiolabel-set span-block">
                                                    <label for="set-<?php echo $product['code']; ?>-ea" class="radio-button active">EA</label>
                                                    <label for="set-<?php echo $product['code']; ?>-pkt" class="radio-button">PKT</label>
                                    ...
                                    <div class="prices right-col">
                                        <div class="price price-my"><span class="label">YOUR PRICE</span> <span class="value">$<?php echo $quantity * $product['price'];?></span></div>
                                        <div class="price price-cmp"><span class="label">CMP </span><span class="value">$<?php echo $quantity * $product['cmp'];?></span></div>
                                    </div>
                                    <div class="clear-fix"></div>
                                </div>
                            </footer>
