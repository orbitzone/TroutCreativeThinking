...
<!-- Begin: HTML Widget-->
        <div class="widget-logo ">
          <header role="banner">
            <img src="images/brand-pages/graf/graf-banner.jpg" width="1200px" alt="graf"/>
          </header>
        </div>
      </div>  
    </div>
  ...
  <div class="container-fluid products align-right">
    <div class="row">
      <div class="col-sm-6 col-sm-push-6">
        ...
        <div class="widget-html-image">
          <figure class="image">
           <img src="images/brand-pages/graf/graf-platin.jpg" alt="graf platin"/>
         </figure>
       </div>
       <!-- End: HTML Widget-->
     </div>
...
<!-- VISIT WEBSITE -->
  <div class="container-fluid visit-website">
    <div class="row">
      <div class="col-xs-12">
        <!-- Begin: HTML Widget-->
        <div class="widget-html-image">
...
<!--VIDEOS -->
   <!-- left side video 1 of 4 -->
    <div class="container-fluid graf-video">
        <div class="row">
            <div class="col-sm-6">
                <!-- Begin: Video Widget-->
