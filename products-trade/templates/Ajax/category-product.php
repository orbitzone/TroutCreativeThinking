	...
	<div class="product-content">
		...
		<div class="product-details-wrap">
			...
			<div class="product-price">
					<?php foreach($product['price'] as $key => $price): ?>
						<div class="product-price-my price-<?php echo $price['unit']; ?>">My Price <span class="value"><?php echo $price['value']; ?><small>inc.</small></span></div>
						<div class="product-price-cmp price-<?php echo $price['unit']; ?>">CMP <span class="value"><?php echo $product['cmp'][$key]['value']; ?><small>inc.</small></span></div>	
					<?php endforeach;?>				
			</div>
			<div class="product-quantity">
				...
				<div class="quantity-units quantity-set">
					...
					<?php
						 ...
						 foreach($product['price'] as $price): 
							...
							<label for="<?php echo "set-".$product['code'].'-'.$price['unit'];?>" class="radio-button <?php if($n == 0){ ?>active<?php }?>"><?php echo $price['unit'];?></label>
						 <?php 
						 if($price['unit'] == "PKT"){
						 		$pack_info = '<span class="quantity-pack-details">Packet Contains <span>'.$product['pack'].'</span> units</span>';
						 }
						 $n = $n+1; 
						endforeach;
						?>					
