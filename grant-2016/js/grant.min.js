...
e.fileType.indexOf("image")>-1?e.fileType="image":e.fileType="invalid","invalid"!=e.fileType?($(this).parent().find(".upload-filename").text(e.fileName),$(this).addClass("uploaded")):$(this).parent().parent().append('<div class="error" style="display:block;" data-num="'+e.numberFiles+'">Invalid file type selected: '+e.fileName+"</div>"))}),$(".steps-list button").on("click",function(){var a=$(this).data("step");d(a)}),$(".steps-navigation button[type=button]").on("click",function(){var a=$(".steps-list button.active").data("step");$(this).hasClass("previous")?a-=1:a+=1,d(a)})},countdown:function(){
