<?php
	$panels = array(
		...
		"1978" => array("bgTurquoiseDark", 'Reece enters the New South Wales market with the opening of its Albury store.'),
		"1980" => array("bgBlue", 'Reece purchases Jesco Plumbing Supplies giving Reece a distribution business covering country Victoria.'),
		"1986" => array("bgBlue", 'Reece Head Office moves from Ringwood to larger, more modern premises in Burwood, Victoria.'),
		...
		"1998-1" => array("bgBlue", 'Reece opens its first ‘Irrigation’ outlet, dedicated to providing a specialised service for irrigation contractors, landscape gardeners and growers.'),
