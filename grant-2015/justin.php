...
<head>
  <?php include "templates/Includes/BasePath.php" ?>
...
<body class="grant-2015">
  <div class="ocmain-wrapper">
    ...
    <div class="grant-2015-content">
                ...
                <div class="row row-limit spacing-big-bottom">
                  <div class="col-sm-5  col-xs-12">
                    ...
                    <div class="donate-button-wrapper">
                      ...
                      <div class="donate-button">
                        <a href="https://www.facebook.com/wecannotwait" target="_blank">
                         <span class="fa fa-facebook-square "></span> We Can&rsquo;t Wait
                       </a>
                     </div>
                   </div>
                 </div>
      ...
      <!--//INTRO SECTION -->
      <div id="latest-article"></div>
      <!--LATEST PROJECTS SECTION -->
      <div class="wave-section latest-project-section one-article-section active">
              ...
              <div class="row row-limit text-left">
                <div class="expand-article text-blue">
                  <div class="col-sm-12">
                    ...
                    <p>Half of the puzzle in India is finding a way to encourage residents - who have been brought up in a culture of open defecation - to use the toilets.We hope that by teaching kids about the importance of washing their hands and proper hygiene, they&rsquo;ll pass on their knowledge to their parents and encourage them to install a toilet into their home. Change needs to happen from the bottom up. </p>
                  ...
                  <div class="col-sm-6">
                    <div class="article-snap">
                      <a  href="images/justin/article1-photo1.jpg" data-lightbox="justin-article1">
                       <img class="img-thumbnail" src="images/justin/article1-photo1.jpg">
                     </a>
                   </div>
                 </div>
                 <div class="col-sm-6">
                  <div class="article-snap">
                    <a href="images/justin/article1-photo2.jpg" data-lightbox="justin-article1">
                     <img class="img-thumbnail" src="images/justin/article1-photo2.jpg">
                   </a>
                 </div>
               </div>
              ...
              <div class="container">
                <div class="row row-limit text-left">
                  <div class="expand-article text-blue">
                    ...
                    <div class="col-sm-6">
                      <div class="article-snap">
                        <a href="images/homepage/snap1.png" data-lightbox="justin-article2">
                         <img class="img-thumbnail" src="images/homepage/snap1.png">
                       </a>
                     </div>
                   </div>
                   <div class="col-sm-6">
                    <div class="article-snap">
                      <a href="images/homepage/snap2.png" data-lightbox="justin-article2">
                       <img class="img-thumbnail" src="images/homepage/snap2.png">
                     </a>
                   </div>
                 </div>
          ...
          <div class="container">
            <div class="row row-limit text-left">
              <div class="expand-article text-blue">
                ...
                <div class="col-sm-6">
                  <div class="article-snap">
                    <a href="images/homepage/snap1.png" data-lightbox="justin-article3">
                     <img class="img-thumbnail" src="images/homepage/snap1.png">
                   </a>
                 </div>
               </div>
               <div class="col-sm-6">
                <div class="article-snap">
                  <a href="images/homepage/snap2.png" data-lightbox="justin-article3">
                   <img class="img-thumbnail" src="images/homepage/snap2.png">
                 </a>
               </div>
             </div>
...
<?php include "templates/Includes/Grant2015Javascript.php" ?>
</body>
</html>