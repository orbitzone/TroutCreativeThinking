...
jQuery(function($){
	...
	moodboard = {
		...
		add: function(obj, product){
			...
			var menuLeft = $('#destination-happiness .menu').offset().left - parseInt($('#main-content').css('margin-left')) +16;
			...
			var heartLeft = $(obj).find('i').offset().left - parseInt($('#main-content').css('margin-left')) + 5; 
