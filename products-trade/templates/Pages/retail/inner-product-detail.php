	...
	<div class="product-detail-wrap">
							...
							<div class="product-images">
								...
								<div class="product-images-slider-wrap">
									<div class="product-images-slider">
										<div class="current">
											<div class="image">
												<img class="img-responsive" src="templates/images/retail/product-detail/product-image1.jpg" alt="item">
											</div>
										</div>
										<div>
											<div class="image">
												<img class="img-responsive" src="templates/images/retail/product-detail/product-image2.jpg" alt="item">
											</div>
										</div>
										<div>
											<div class="image">
												<img class="img-responsive" src="templates/images/retail/product-detail/product-image3.jpg" alt="item">
											</div>
										</div>
										<div>
											<a href="#" title="Watch video"  class="lightbox-video" data-video="F-kP7xe9j70">
												<img class="img-responsive" src="templates/images/retail/product-detail/product-image4.jpg" alt="item">
		...
		<path d="M29.4,17.5c0.2,0,0.2-0.2,0.4-0.3c0.6-0.5,1.2-0.9,1.2-1.8c0-0.2,0-0.4-0.2-0.4c-0.2,0-1.1,1.1-1.2,1.4
			c-0.1,0.3-0.1,0.6-0.2,0.8c0,0,0,0,0,0.1C29.3,17.3,29.3,17.3,29.4,17.5C29.3,17.5,29.4,17.5,29.4,17.5z"/>
							...
							<div class="product-intro">
								...
								<div class="product-description">
									<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis ac posuere arcu. Fusce et leo.</p>
								</div>
							</div>
							<div class="product-details">
								...
								<div class="product-postcode-input">
									...
									<div class="product-postcode-input-text">
										<b>Pricing</b>
			...
			c0,0.5,0.4,0.9,0.9,0.9h32.1l-4.9,14.9H12.9c-0.5,0-0.9,0.4-0.9,0.9C12,23.8,12.4,24.2,12.9,24.2z"/></svg></span>
														<span class="add-to-wishlist-text">add to wishlist
	  ...
	  <path d="M1644.29,629.674a1.048,1.048,0,0,0-1.12,1.107v4.43a1.047,1.047,0,0,0,1.12,1.1h4.48a1.052,1.052,0,0,0,1.12-1.1v-4.43a1.053,1.053,0,0,0-1.12-1.107h-4.48Zm12.31,0v6.641h58.23v-6.641H1656.6Zm-12.31,15.5a1.048,1.048,0,0,0-1.12,1.107v4.429a1.048,1.048,0,0,0,1.12,1.106h4.48a1.053,1.053,0,0,0,1.12-1.106V646.28a1.053,1.053,0,0,0-1.12-1.107h-4.48Zm12.31,0v6.642h44.8v-6.642h-44.8Zm-12.31,15.5a1.048,1.048,0,0,0-1.12,1.107v4.427a1.049,1.049,0,0,0,1.12,1.109h4.48a1.054,1.054,0,0,0,1.12-1.109v-4.427a1.053,1.053,0,0,0-1.12-1.107h-4.48Zm12.31,0v6.643h58.23v-6.643H1656.6Zm-12.31,15.5a1.046,1.046,0,0,0-1.12,1.1v4.43a1.048,1.048,0,0,0,1.12,1.107h4.48a1.053,1.053,0,0,0,1.12-1.107v-4.43a1.052,1.052,0,0,0-1.12-1.1h-4.48Zm12.31,0v6.642h53.75v-6.642H1656.6Z" transform="translate(-1643.16 -629.688)"/>
								...
								<div class="product-icons">
									<div class="row">
										<div class="col-xs-6">
											<div class="item">
													<img src="templates/images/general/product-detail/seven-years-quality-guarantee.jpg" alt="Seven years Quality Guarantee"/>
													<span>Domestic Use</span>											
											</div>
										</div>
										<div class="col-xs-6">
											<div class="item">
													<img src="templates/images/general/product-detail/promo.jpg" alt="Promo"/>
													<span>PROMO</span>											
											</div>
										</div>
									</div>
...
<path d="M0.6,0.6c-0.8,0.8-0.9,2.2,0,3.1c0,0,0,0,0,0l22.8,22.8c0.9,0.8,2.2,0.8,3.1,0L49.4,3.7
	c0.8-0.9,0.8-2.2,0-3.1c-0.9-0.8-2.2-0.8-3.1,0L25,21.9L3.7,0.6C2.9-0.2,1.5-0.2,0.6,0.6C0.6,0.6,0.6,0.6,0.6,0.6z"/>
							...
							<div class="product-share">
								<b class="text-cursive"><span class="text-as-svg"><svg width="137.7px" height="15px" viewBox="0 0 137.7 15"><text x="0" y="0">Share this product</text>
<path d="M8.7,1.3C9,1.3,9,0.8,9.3,0.8c0.1,0,0.2,0.1,0.2,0.2c0,0.1-0.2,1.2-0.5,3.4C8.8,4.7,8.8,4.8,8.7,4.8
	C8.4,4.8,8.6,4,8.2,2.9c-0.5-1.2-1.4-2-2.6-2c-1.2,0-2.1,0.9-2.1,1.9S4.1,4,5.1,4.6c1.9,1,3.6,1.5,3.6,3.3c0,2-1.9,3.9-4.6,3.9
	c-1.5,0-2.7-0.8-3.2-0.8s-0.5,0.5-0.8,0.5c-0.1,0-0.1,0-0.1-0.1c0-0.1,0.2-1.6,0.8-4.3C0.9,6.9,0.9,6.7,1,6.7S1.2,6.8,1.2,7
	c0,0.2,0,0.5,0,0.7c0,2.2,1.2,3.7,2.9,3.7c1.5,0,2.6-1.1,2.6-2.4C6.7,7.9,6,7.5,4.9,7C3,6.1,1.7,5.6,1.7,3.9c0-1.8,1.7-3.5,3.9-3.5
	C7.3,0.5,8.1,1.3,8.7,1.3z M11.6,1.5c0-0.5-0.9-0.5-0.9-0.8c0-0.3,1.2-0.1,3.2-0.8l-1.5,6.9c0.8-1.8,1.7-2.6,2.9-2.6
	c1.1,0,1.9,0.7,1.9,1.8c0,0.5-0.1,1-0.2,1.5l-0.4,1.7c-0.2,0.6-0.2,1-0.2,1.2c0,0.3,0.2,0.5,0.4,0.5c0.4,0,0.8-0.5,1.1-1.4
	c0.1-0.3,0.1-0.5,0.3-0.5c0.1,0,0.2,0.1,0.2,0.2c0,0.1-0.1,0.5-0.3,1c-0.5,1-1.2,1.5-2,1.5c-0.9,0-1.5-0.5-1.5-1.5
	c0-0.3,0.1-0.8,0.2-1.2l0.5-2.3c0.2-0.5,0.3-0.9,0.3-1.1c0-0.5-0.2-0.7-0.6-0.7c-1.1,0-2.4,2.3-3.3,6.9c-0.3-0.2-0.7-0.3-1-0.3
	c-0.3,0-0.6,0.1-1,0.3l2.1-9.7C11.6,1.9,11.6,1.8,11.6,1.5z M27.1,4.3c0.1,0,0.2,0.1,0.2,0.2c0,0.2-0.5,0.7-0.7,1.9l-0.6,3
	c-0.2,0.6-0.2,1-0.2,1.2c0,0.3,0.2,0.5,0.4,0.5c0.4,0,0.8-0.5,1.1-1.4c0.1-0.3,0.1-0.5,0.3-0.5c0.1,0,0.2,0.1,0.2,0.2
	c0,0.1-0.1,0.5-0.3,1c-0.5,1-1.2,1.5-2,1.5c-0.9,0-1.5-0.5-1.5-1.5c0-0.2,0-0.5,0.1-0.9c-0.7,1.5-1.8,2.4-2.9,2.4
	c-1.4,0-2.2-1.1-2.2-2.6c0-1.1,0.5-2.3,1.3-3.3C21,4.8,22,4.3,23,4.3c0.9,0,1.5,0.5,1.7,1.6C25.6,4.8,26.6,4.3,27.1,4.3z M21.6,6.2
	C21,7.7,20.7,9,20.7,9.8c0,1,0.3,1.5,0.9,1.5s1.2-0.5,1.9-1.7c0.5-1,0.9-2.3,0.9-3.3c0-1.1-0.4-1.6-1.2-1.6
	C22.7,4.6,22.2,5.1,21.6,6.2z M29.8,6.1c0-0.2,0.1-0.3,0.1-0.5c0-0.4-0.2-0.5-0.4-0.5c-0.3,0-0.7,0.3-0.9,1C28.3,6.7,28.4,7,28.2,7
	c-0.1,0-0.2-0.1-0.2-0.2c0-0.1,0.1-0.5,0.4-1.1c0.5-0.9,1.2-1.5,2-1.5c0.9,0,1.4,0.5,1.4,1.6c0,0.2,0,0.6-0.1,1.1
	c0.8-1.8,1.9-2.6,2.8-2.6c0.7,0,1.1,0.5,1.1,1.2s-0.5,1.2-1.1,1.2c-0.7,0-1-0.5-1.4-0.5c-1,0-1.6,1.9-2.4,5.8
	c-0.4-0.2-0.7-0.3-0.9-0.3c-0.4,0-0.7,0.1-1.1,0.3L29.8,6.1z M37.5,8.4c0,1.4,0.9,2.2,2.2,2.2c1.5,0,1.9-1.1,2.1-1.1
	c0.1,0,0.1,0.1,0.1,0.1c0,0.1-0.2,0.5-0.5,0.9c-0.8,0.8-1.8,1.2-2.9,1.2c-1.7,0-3-1.2-3-3c0-2.6,2.1-4.6,4.6-4.6
	c1.4,0,2.2,0.7,2.2,1.6C42.1,7.2,40.4,8.2,37.5,8.4C37.5,8.4,37.5,8.4,37.5,8.4z M40.7,5.4c0-0.5-0.3-0.9-0.8-0.9
	c-1,0-2.2,1.3-2.4,3.5C39.4,8,40.7,6.7,40.7,5.4z M51.3,4.5h1.9l-0.3,0.8h-1.6l-0.9,4.5c-0.1,0.2-0.1,0.4-0.1,0.5
	c0,0.5,0.2,0.8,0.7,0.8c0.9,0,1.5-1.3,1.7-1.3c0.1,0,0.2,0.1,0.2,0.2s-0.2,0.5-0.5,0.9c-0.7,0.8-1.3,1.1-2.2,1.1
	c-1.1,0-1.9-0.6-1.9-1.7c0-0.2,0-0.5,0.1-0.9l0.9-4h-1.3c1.5-0.6,2.9-1.7,4-3.2L51.3,4.5z M55.3,1.5c0-0.5-0.9-0.5-0.9-0.8
	c0-0.3,1.2-0.1,3.2-0.8l-1.5,6.9c0.8-1.8,1.7-2.6,2.9-2.6c1.2,0,1.9,0.7,1.9,1.8c0,0.5-0.1,1-0.2,1.5l-0.4,1.7
	c-0.2,0.6-0.2,1-0.2,1.2c0,0.3,0.2,0.5,0.4,0.5c0.4,0,0.8-0.5,1.1-1.4c0.1-0.3,0.1-0.5,0.3-0.5c0.1,0,0.2,0.1,0.2,0.2
	c0,0.1-0.1,0.5-0.3,1c-0.5,1-1.2,1.5-2,1.5c-0.9,0-1.5-0.5-1.5-1.5c0-0.3,0.1-0.8,0.2-1.2l0.5-2.3C58.9,6.2,59,5.9,59,5.6
	c0-0.5-0.2-0.7-0.6-0.7c-1.1,0-2.4,2.3-3.3,6.9c-0.3-0.2-0.7-0.3-1-0.3c-0.3,0-0.5,0.2-0.9,0.3l2.1-9.7C55.3,1.9,55.3,1.8,55.3,1.5z
	 M65.2,9.3c-0.2,0.5-0.2,0.9-0.2,1.2c0,0.4,0.2,0.6,0.4,0.6c0.4,0,0.8-0.5,1.1-1.4c0.1-0.3,0.1-0.5,0.3-0.5c0.1,0,0.2,0.1,0.2,0.2
	c0,0.1-0.1,0.5-0.3,1c-0.5,1-1.2,1.5-2,1.5c-1,0-1.5-0.5-1.5-1.5c0-0.3,0.1-0.7,0.2-1.2l0.6-2.2C63.9,6.3,64,6,64,5.6
	c0-0.4-0.2-0.5-0.4-0.5c-0.3,0-0.7,0.4-1,1.1C62.4,6.7,62.4,7,62.2,7c-0.1,0-0.2-0.1-0.2-0.2c0-0.1,0.1-0.6,0.5-1.2
	c0.5-0.9,1.2-1.3,2-1.3c0.9,0,1.5,0.6,1.5,1.5C66,6.1,66,6.5,65.8,7L65.2,9.3z M67.1,1.7c0,0.7-0.6,1.3-1.3,1.3c-0.6,0-1-0.5-1-1
	c0-0.7,0.6-1.3,1.3-1.3C66.6,0.7,67.1,1.1,67.1,1.7z M74.3,5.9c0,0.5-0.4,0.8-0.9,0.8c-0.9,0-0.9-0.9-1-1.5c-0.1-0.5-0.4-0.7-1-0.7
	c-0.9,0-1.4,0.5-1.4,1.1s0.5,0.9,1.6,1.3c1.5,0.6,2.1,1.2,2.1,2.3c0,1.4-1.4,2.6-3.4,2.6c-1.9,0-2.9-0.9-2.9-1.9c0-0.6,0.4-1,0.9-1
	s0.9,0.5,1,1.3c0.1,0.8,0.2,1.2,1.2,1.2s1.7-0.5,1.7-1.4c0-0.7-0.6-0.9-1.7-1.4c-1.3-0.5-2.2-1-2.2-2.1c0-1.3,1.3-2.4,3.2-2.4
	C73.2,4.3,74.3,5.1,74.3,5.9z M86.2,4.3c1.4,0,2.4,1.2,2.4,2.9c0,1.3-0.5,2.5-1.5,3.5c-0.9,0.9-1.9,1.3-2.8,1.3
	c-0.9,0-1.5-0.2-1.9-0.5L81.6,15c-0.4-0.2-0.7-0.3-1-0.3s-0.6,0.1-1,0.3l1.9-8.9c0-0.2,0.1-0.3,0.1-0.5c0-0.3-0.2-0.5-0.4-0.5
	c-0.3,0-0.6,0.3-0.9,1C79.9,6.8,80,7,79.9,7c-0.1,0-0.2-0.1-0.2-0.2c0-0.1,0.1-0.5,0.3-1c0.5-1,1.2-1.5,2-1.5c0.9,0,1.3,0.5,1.3,1.5
	c0,0.2,0,0.5-0.1,1.1C84,5.1,85.1,4.3,86.2,4.3z M85.7,4.9c-0.5,0-1.2,0.5-1.8,1.6c-0.7,1.4-1.1,2.7-1.1,3.6c0,1,0.5,1.5,1.2,1.5
	c0.6,0,1.2-0.5,1.6-1.3c0.5-1.1,0.9-2.6,0.9-4C86.5,5.3,86.2,4.9,85.7,4.9z M90.9,6.1C90.9,6,91,5.8,91,5.6c0-0.4-0.2-0.5-0.4-0.5
	c-0.3,0-0.7,0.3-0.9,1C89.4,6.7,89.5,7,89.3,7c-0.1,0-0.2-0.1-0.2-0.2c0-0.1,0.1-0.5,0.4-1.1c0.5-0.9,1.2-1.5,2-1.5
	c0.9,0,1.4,0.5,1.4,1.6c0,0.2,0,0.6-0.1,1.1c0.8-1.8,1.9-2.6,2.8-2.6c0.7,0,1.1,0.5,1.1,1.2s-0.5,1.2-1.1,1.2c-0.7,0-1-0.5-1.4-0.5
	c-1,0-1.6,1.9-2.4,5.8c-0.4-0.2-0.7-0.3-0.9-0.3c-0.4,0-0.7,0.1-1.1,0.3L90.9,6.1z M104.3,7.5c0,2.4-1.9,4.3-4.5,4.3
	c-2,0-3.4-1.4-3.4-3.2c0-1.4,0.8-2.8,2.1-3.6c0.8-0.5,1.5-0.7,2.3-0.7C102.9,4.3,104.3,5.6,104.3,7.5z M101.1,4.6
	c-0.6,0-1.1,0.4-1.5,1.1c-0.6,1-1,2.6-1,3.9c0,1.2,0.5,1.9,1.3,1.9c0.6,0,1.1-0.4,1.5-1.2c0.5-1,0.9-2.6,0.9-3.9
	C102.3,5.3,101.9,4.6,101.1,4.6z M112.1,1.5c0-0.5-0.8-0.5-0.8-0.8c0-0.3,1.2-0.1,3.2-0.8l-1.9,9.3c-0.2,0.5-0.2,1-0.2,1.2
	c0,0.3,0.2,0.5,0.4,0.5c0.4,0,0.8-0.5,1.1-1.4c0.1-0.3,0.1-0.5,0.3-0.5c0.1,0,0.2,0.1,0.2,0.2c0,0.1-0.1,0.5-0.3,1
	c-0.5,1-1.2,1.5-2,1.5c-0.9,0-1.5-0.6-1.5-1.8c0-0.2,0-0.3,0-0.5c-0.7,1.5-1.8,2.2-2.9,2.2c-1.3,0-2.2-1.1-2.2-2.6
	c0-1.1,0.5-2.2,1.3-3.2c0.9-1.1,2-1.6,2.9-1.6s1.5,0.5,1.7,1.5l0.8-3.6C112.1,1.9,112.1,1.8,112.1,1.5z M108.2,6.5
	c-0.5,1.3-0.7,2.5-0.7,3.2c0,0.9,0.3,1.4,0.9,1.4c0.5,0,1.2-0.5,1.7-1.6c0.5-1,0.9-2.3,0.9-3.3c0-1.1-0.5-1.7-1.1-1.7
	C109.2,4.6,108.6,5.3,108.2,6.5z M117.2,11.8c-1.1,0-1.9-0.7-1.9-1.7c0-0.6,0.2-1.1,0.2-1.6l0.4-1.7c0.2-0.6,0.2-1,0.2-1.2
	c0-0.3-0.2-0.5-0.4-0.5c-0.4,0-0.8,0.5-1.1,1.4c-0.1,0.3-0.2,0.5-0.3,0.5c-0.1,0-0.2-0.1-0.2-0.2c0-0.1,0.1-0.5,0.3-1
	c0.5-1,1.2-1.5,2-1.5c0.9,0,1.5,0.5,1.5,1.5c0,0.3,0,0.7-0.2,1.2l-0.5,2.3c-0.1,0.5-0.2,0.9-0.2,1.2c0,0.5,0.2,0.7,0.6,0.7
	c1.1,0,2.4-2.3,3.3-6.9c0.4,0.2,0.7,0.3,1,0.3c0.3,0,0.6-0.1,1-0.3l-1.2,5.7c0,0.2-0.1,0.3-0.1,0.5c0,0.3,0.2,0.5,0.4,0.5
	c0.3,0,0.7-0.4,1-1.1c0.2-0.5,0.2-0.8,0.4-0.8c0.1,0,0.2,0.1,0.2,0.2s-0.1,0.5-0.4,1.1c-0.5,0.9-1.2,1.5-2.1,1.5
	c-0.8,0-1.3-0.6-1.3-1.6c0-0.2,0.1-0.6,0.1-1.1C119.3,11,118.5,11.8,117.2,11.8z M131.6,6.4c0,0.8-0.5,1.3-1.1,1.3
	c-0.5,0-0.9-0.4-0.9-1c0-0.4,0.2-0.8,0.2-1.1c0-0.6-0.3-0.9-0.9-0.9c-1.3,0-2.3,1.6-2.3,3.7c0,1.6,0.9,2.6,2.2,2.6
	c1.3,0,2-1.2,2.2-1.2c0.1,0,0.1,0,0.1,0.1s-0.2,0.5-0.5,0.9c-0.8,0.9-1.9,1.3-2.9,1.3c-1.9,0-3.2-1.2-3.2-3.2c0-2.4,2-4.5,4.5-4.5
	C130.4,4.3,131.6,5.3,131.6,6.4z M135.9,4.5h1.8l-0.3,0.8h-1.6l-0.9,4.5c-0.1,0.2-0.1,0.4-0.1,0.5c0,0.5,0.2,0.8,0.7,0.8
	c0.9,0,1.5-1.3,1.7-1.3c0.1,0,0.2,0.1,0.2,0.2s-0.2,0.5-0.5,0.9c-0.7,0.8-1.3,1.1-2.2,1.1c-1.1,0-1.9-0.6-1.9-1.7
	c0-0.2,0-0.5,0.1-0.9l0.9-4h-1.3c1.5-0.6,2.9-1.7,4-3.2L135.9,4.5z"/>
</svg>
...
<path d="M17.5,6.1c0,0.2,0,0.3,0,0.5c0,5.1-3.9,11-11,11c-2.2,0-4.2-0.6-6-1.7c0.3,0,0.6,0,0.9,0
	...
	<path d="M12,9c0,0.1-0.1,0.2-0.2,0.2h-1.6v1.2c0,0.4-0.3,0.7-0.7,0.7H2.5c-0.4,0-0.7-0.3-0.7-0.7V9.2H0.2C0.1,9.2,0,9.1,0,9V6
		...
		<section id="product-summary" class="section">
			<div class="container-fluid section-container">
				<div class="section-content">
					<header class="section-title"><h3>Product Summary</h3></header>
					<p>Sassy and chic, Milli embodies fashion - setting the standard for in Vogue tapware design. Inspired by the beauty and perfection of the blade, the Milli Axon Wall Basin Mixer Set in Rose Gold/Black is a revolution in design. Sheer lines are brought to life through the use of a slimline 27mm cartridge and solid brass construction.</p>
				</div>
			</div>
		</section>
		<!-- END PRODUCT SUMMARY-->
					...
					<div class="row">
						<div class="col-xs-12">
							<ul class="list-inline">
								<li>
									<div class="icon">
										<img class="img-responsive" src="templates/images/retail/product-detail/icon-target.png" alt="item">
									</div>
									<div class="text">
										Lorem ipsum doilor sit amet
									</div>
								</li>
								<li>
									<div class="icon">
										<img class="img-responsive" src="templates/images/retail/product-detail/icon-bulb.png" alt="item">
									</div>
									<div class="text">
										Lorem ipsum doilor sit amet
									</div>
								...
								<li>
									<div class="icon">
										<img class="img-responsive" src="templates/images/retail/product-detail/icon-disc.png" alt="item">
									</div>
									<div class="text">
										Lorem ipsum doilor sit amet
									</div>
								...
								<li>
									<div class="icon">
										<img class="img-responsive" src="templates/images/retail/product-detail/icon-diamond.png" alt="item">
									</div>
									<div class="text">
										Lorem ipsum doilor sit amet
									</div>
								...
								<li>
									<div class="icon">
										<img class="img-responsive" src="templates/images/retail/product-detail/icon-dna.png" alt="item">
									</div>
									<div class="text">
										Lorem ipsum doilor sit amet
									</div>
		...
		<!-- END PRODCUT HIGHLIGHTS-->
		<!-- START PRODUCT DISPLAY -->
		<section id="product-display" class="grey-stripes-bg section">
			<div class="container-fluid section-container">
				<div class="section-content">
					<header data-expandbutton="product-on-display" class="section-title action-expand-button">
							<h3 class="section-heading">See this product on display at 
					...
					<div data-expandsection="product-on-display" class="expand-section expanded-desktop">
						<div class="row">
							<div class="col-xs-12">
...
<path d="M0.6,0.6C0.2,1,0,1.5,0,2c0,0.5,0.2,1,0.6,1.4l21,21c0.8,0.8,2.1,0.8,2.8,0l21-21c0.8-0.8,0.8-2.1,0-2.8
	c-0.8-0.8-2.1-0.8-2.8,0L23,20.2L3.4,0.6C2.6-0.2,1.3-0.2,0.6,0.6z"/>
				...
				<div data-expandsection="technical" class="expand-section expanded-desktop">
					<div class="inner-info">
						<div class="row">
							<div class="col-sm-6">
...
<path d="M17.7,5h-2.1C15.3,5,15,4.7,15,4.3V2.4C15,1.1,14,0,12.7,0H2.3C1,0,0,1.1,0,2.4v21.9c0,1.3,1,2.4,2.3,2.4h15.4
	...
	<path d="M0.6,0.6C0.2,1,0,1.5,0,2c0,0.5,0.2,1,0.6,1.4l21,21c0.8,0.8,2.1,0.8,2.8,0l21-21c0.8-0.8,0.8-2.1,0-2.8
		c-0.8-0.8-2.1-0.8-2.8,0L23,20.2L3.4,0.6C2.6-0.2,1.3-0.2,0.6,0.6z"/>
						...
						<div data-expandsection="warranty" class="expand-section expanded-desktop">
								<div class="inner-info">
									<div class="row">
										<div class="col-sm-6">
											<h6 class="table-heading">Product Information</h6>
...
<path d="M17.7,5h-2.1C15.3,5,15,4.7,15,4.3V2.4C15,1.1,14,0,12.7,0H2.3C1,0,0,1.1,0,2.4v21.9c0,1.3,1,2.4,2.3,2.4h15.4
	...
	c-0.5,0-0.8,0.4-0.8,0.8c0,0.5,0.4,0.8,0.8,0.8h11.7c0.5,0,0.8-0.4,0.8-0.8C16.7,20.4,16.3,20,15.8,20"/>
		...
		c-0.8-0.8-2.1-0.8-2.8,0L23,20.2L3.4,0.6C2.6-0.2,1.3-0.2,0.6,0.6z"/>
							...
							<div data-expandsection="installation" class="expand-section expanded-desktop">
								<div class="inner-info">
									<div class="row">
										<div class="col-xs-12">
												...
												<div class="one-slide">
													<div class="video-thumbnail">
														<a href="#" title="Watch video"  class="lightbox-video" data-video="Etkva-n4_4s">
															<span class="thumb-image"><img class="img-responsive" src="templates/images/retail/product-detail/video-thumb<?php echo 1+$i%3 ?>.jpg" alt="item"></span>
															<span class="play-button">
																<svg width="46.5px" height="46.5px" viewBox="0 0 46.5 46.5">
																	<path class="ring" d="M23.2,46.5C10.4,46.5,0,36.1,0,23.3S10.4,0,23.2,0c12.8,0,23.2,10.4,23.2,23.3S36.1,46.5,23.2,46.5z M23.2,1
																		C11,1,1,11,1,23.3c0,12.3,10,22.3,22.2,22.3c12.3,0,22.2-10,22.2-22.3C45.5,11,35.5,1,23.2,1z"/>
...
<path d="M17.7,5h-2.1C15.3,5,15,4.7,15,4.3V2.4C15,1.1,14,0,12.7,0H2.3C1,0,0,1.1,0,2.4v21.9c0,1.3,1,2.4,2.3,2.4h15.4
	...
	c-0.5,0-0.8,0.4-0.8,0.8c0,0.5,0.4,0.8,0.8,0.8h11.7c0.5,0,0.8-0.4,0.8-0.8C16.7,20.4,16.3,20,15.8,20"/>
		...
		<section class="section videos-section" id="videos">
			<div class="container-fluid section-container">
				<div class="section-content">
				<header data-expandbutton="videos-area" class="section-title action-expand-button">
				<h3 class="section-heading">Videos
							<svg xmlns="http://www.w3.org/2000/svg" width="46px" height="25px" viewBox="0 0 46 25">
						<path d="M0.6,0.6C0.2,1,0,1.5,0,2c0,0.5,0.2,1,0.6,1.4l21,21c0.8,0.8,2.1,0.8,2.8,0l21-21c0.8-0.8,0.8-2.1,0-2.8
		c-0.8-0.8-2.1-0.8-2.8,0L23,20.2L3.4,0.6C2.6-0.2,1.3-0.2,0.6,0.6z"/>
					</svg>
							</h3></header>
							<div data-expandsection="videos-area" class="expand-section expanded-desktop">
								<div class="inner-info">
									<div class="row">
										<div class="col-xs-12">
		...
		<!--START COMPLETE THE LOOK SECTION -->
		<div class="section product-suggestion-section bg-light-stripes" id="complete-the-look">
			<div class="container-fluid section-container">
				<div class="section-content no-border">
					<div class="row">
						<div class="col-xs-12">
							<div class="inner-wrap">
								<header data-expandbutton="product-suggestion" class="section-title text-center"><h3 class="section-heading text-cursive"><span class="text-as-svg"><svg width="222.9" height="35.2" viewBox="0 0 222.9 35.2">
								<text x="0" y="15" fill="red">Complete the look</text>
	<path d="M23.8,6.7C24,6.7,24,6.8,24,6.9c0,0.5-0.5,2.7-1.1,6.4c-0.1,0.3-0.1,0.4-0.3,0.4c-0.3,0-0.2-0.5-0.4-1.4
		c-0.8-3.5-2.6-5.3-5-5.3c-1.7,0-3,0.9-4.1,2.6c-1.3,2.1-2.4,5.8-2.4,9.1c0,3.4,1.5,5.3,3.9,5.3c1.7,0,3.8-1,5.4-2.8
		c1.8-2,2-3.7,2.4-3.7c0.1,0,0.2,0.1,0.2,0.2c0,0.3-0.4,1.8-1.1,4.3c-0.4,1.6-0.4,2.4-0.8,2.4c-0.5,0-0.1-1-0.9-1
		c-0.8,0-2.3,1.1-5.2,1.1c-4.4,0-7.7-3.1-7.7-7.8c0-2.5,1-5,2.7-7c2-2.2,4.7-3.4,7.1-3.4c3.1,0,4.7,1.6,5.7,1.6S23.4,6.7,23.8,6.7z"
		/>
	<path d="M37.2,17.7c0,3.8-3.1,7-7.1,7c-3.2,0-5.4-2.2-5.4-5.3c0-2.3,1.2-4.4,3.3-5.8c1.2-0.8,2.5-1.2,3.8-1.2
		C35,12.4,37.2,14.6,37.2,17.7z M32,13c-0.9,0-1.8,0.6-2.5,1.8c-0.9,1.6-1.6,4.1-1.6,6.2c0,2,0.8,3.1,2.1,3.1c1,0,1.8-0.6,2.5-1.9
		c0.9-1.6,1.5-4.1,1.5-6.2C34,14,33.4,13,32,13z"/>
	<path d="M48.8,12.5c1.7,0,2.8,1.1,2.8,2.8c0,0.4-0.1,0.9-0.2,1.4c1.3-2.8,2.7-4.2,4.6-4.2c1.7,0,2.9,1.1,2.9,2.8
		c0,0.8-0.2,1.6-0.4,2.5L58,20.5c-0.2,0.9-0.3,1.6-0.3,2c0,0.5,0.2,0.9,0.6,0.9c0.6,0,1.2-0.8,1.7-2.3c0.2-0.5,0.2-0.8,0.5-0.8
		c0.1,0,0.2,0.1,0.2,0.3c0,0.2-0.1,0.8-0.5,1.6c-0.7,1.7-1.8,2.5-3.2,2.5c-1.4,0-2.3-0.9-2.3-2.5c0-0.6,0.2-1.2,0.3-2l0.8-3.7
		c0.2-0.8,0.3-1.5,0.3-1.8c0-0.8-0.3-1.1-1-1.1c-1.8,0-4,3.7-5.4,11.1c-0.5-0.3-0.9-0.4-1.4-0.4c-0.5,0-1,0.2-1.6,0.5l1.7-8.1
		c0.2-0.9,0.3-1.5,0.3-1.8c0-0.8-0.4-1.1-1-1.1c-1.8,0-3.9,3.7-5.3,11.1c-0.5-0.3-0.9-0.4-1.4-0.4s-1,0.2-1.6,0.5l2-9.2
		c0.1-0.3,0.1-0.5,0.1-0.7c0-0.6-0.2-0.9-0.6-0.9c-0.5,0-1.1,0.6-1.6,1.7c-0.4,0.9-0.4,1.3-0.7,1.3c-0.1,0-0.2-0.1-0.2-0.2
		c0-0.1,0.1-0.8,0.6-1.7c0.7-1.5,2-2.4,3.2-2.4c1.3,0,2.2,0.9,2.2,2.6c0,0.4-0.1,1-0.2,1.7C45.4,13.9,46.9,12.5,48.8,12.5z"/>
	<path d="M71.6,12.5c2.2,0,3.8,2,3.8,4.5c0,2.1-0.8,4-2.4,5.6c-1.4,1.4-3,2.1-4.5,2.1c-1.3,0-2.3-0.3-2.9-0.9l-1.2,5.8
		c-0.6-0.3-1.1-0.4-1.6-0.4c-0.5,0-1,0.2-1.6,0.5l3-14.2c0.1-0.2,0.1-0.5,0.1-0.7c0-0.5-0.3-0.9-0.6-0.9c-0.4,0-1,0.5-1.5,1.6
		s-0.4,1.4-0.7,1.4c-0.1,0-0.2-0.1-0.2-0.2c0-0.1,0.1-0.8,0.5-1.7c0.8-1.6,2-2.4,3.2-2.4c1.3,0,2.2,0.9,2.2,2.5
		c0,0.3-0.1,0.9-0.2,1.7C68.1,13.9,69.7,12.5,71.6,12.5z M70.7,13.4c-0.9,0-1.9,0.9-2.8,2.6c-1.2,2.2-1.7,4.4-1.7,5.7
		c0,1.6,0.8,2.4,1.8,2.4c0.9,0,1.9-0.7,2.6-2.1c0.9-1.8,1.5-4.1,1.5-6.4C72.1,14.2,71.5,13.4,70.7,13.4z"/>
	<path d="M80,20.5c-0.2,0.9-0.3,1.6-0.3,2c0,0.5,0.3,0.9,0.6,0.9c0.6,0,1.2-0.8,1.7-2.3c0.2-0.5,0.2-0.8,0.5-0.8
		c0.1,0,0.2,0.1,0.2,0.3c0,0.2-0.1,0.8-0.5,1.6c-0.7,1.7-1.8,2.5-3.5,2.5c-1.4,0-2.3-0.9-2.3-2.5c0-0.6,0.2-1.2,0.3-2L79.1,9
		c0.1-0.4,0.1-0.6,0.1-0.8c0-1-1.3-0.9-1.3-1.3c0-0.5,1.8-0.1,5.2-1.3L80,20.5z"/>
	<path d="M86.9,19.1c0,2.2,1.4,3.6,3.5,3.6c2.5,0,3.1-1.7,3.4-1.7c0.1,0,0.2,0.1,0.2,0.2c0,0.2-0.3,0.8-0.9,1.5
		c-1.2,1.3-2.8,2-4.7,2c-2.8,0-4.8-2-4.8-4.9c0-4,3.3-7.4,7.3-7.4c2.2,0,3.6,1.1,3.6,2.6c0,2.1-2.7,3.7-7.6,4
		C86.9,19.1,86.9,19.1,86.9,19.1z M92,14.3c0-0.8-0.5-1.4-1.2-1.4c-1.7,0-3.5,2.1-3.8,5.5C90,18.4,92,16.4,92,14.3z"/>
	<path d="M101.5,12.8h2.9l-0.5,1.2h-2.6l-1.5,7.2c-0.1,0.3-0.1,0.6-0.1,0.8c0,0.8,0.4,1.2,1.1,1.2c1.4,0,2.3-2.1,2.7-2.1
		c0.1,0,0.2,0.1,0.2,0.3c0,0.3-0.3,0.8-0.9,1.5c-1.1,1.2-2.1,1.7-3.5,1.7c-1.7,0-2.9-1-2.9-2.7c0-0.4,0-0.9,0.2-1.4l1.4-6.5h-2.1
		c2.5-1,4.6-2.7,6.5-5.1L101.5,12.8z"/>
	<path d="M108.4,19.1c0,2.2,1.4,3.6,3.5,3.6c2.5,0,3.1-1.7,3.4-1.7c0.1,0,0.2,0.1,0.2,0.2c0,0.2-0.3,0.8-0.9,1.5
		c-1.2,1.3-2.8,2-4.7,2c-2.8,0-4.8-2-4.8-4.9c0-4,3.3-7.4,7.3-7.4c2.2,0,3.6,1.1,3.6,2.6c0,2.1-2.7,3.7-7.6,4
		C108.4,19.1,108.4,19.1,108.4,19.1z M113.4,14.3c0-0.8-0.5-1.4-1.2-1.4c-1.7,0-3.5,2.1-3.8,5.5C111.5,18.4,113.4,16.4,113.4,14.3z"
		/>
	<path d="M130.6,12.8h2.9l-0.5,1.2h-2.6l-1.5,7.2c-0.1,0.3-0.1,0.6-0.1,0.8c0,0.8,0.4,1.2,1.1,1.2c1.4,0,2.3-2.1,2.7-2.1
		c0.1,0,0.2,0.1,0.2,0.3c0,0.3-0.3,0.8-0.9,1.5c-1.1,1.2-2.1,1.7-3.5,1.7c-1.7,0-2.9-1-2.9-2.7c0-0.4,0-0.9,0.2-1.4L127,14h-2.1
		c2.5-1,4.6-2.7,6.5-5.1L130.6,12.8z"/>
	<path d="M136.9,8.2c0-0.9-1.3-0.9-1.3-1.2c0-0.5,1.9-0.1,5.1-1.3l-2.4,11.1c1.3-2.8,2.7-4.2,4.6-4.2c1.8,0,2.9,1.1,2.9,2.8
		c0,0.8-0.2,1.6-0.4,2.5l-0.6,2.7c-0.2,0.9-0.3,1.6-0.3,2c0,0.5,0.2,0.9,0.6,0.9c0.6,0,1.2-0.8,1.7-2.3c0.2-0.5,0.2-0.8,0.5-0.8
		c0.1,0,0.2,0.1,0.2,0.3c0,0.2-0.1,0.8-0.5,1.6c-0.7,1.7-1.8,2.5-3.2,2.5c-1.5,0-2.4-0.9-2.4-2.5c0-0.5,0.1-1.2,0.3-2l0.8-3.7
		c0.2-0.8,0.3-1.4,0.3-1.8c0-0.8-0.3-1.2-1-1.2c-1.7,0-3.9,3.7-5.3,11.1c-0.5-0.3-1.1-0.4-1.6-0.4c-0.5,0-1,0.2-1.6,0.5L136.8,9
		C136.8,8.7,136.9,8.4,136.9,8.2z"/>
	<path d="M151.6,19.1c0,2.2,1.4,3.6,3.5,3.6c2.5,0,3.1-1.7,3.4-1.7c0.1,0,0.2,0.1,0.2,0.2c0,0.2-0.3,0.8-0.9,1.5
		c-1.2,1.3-2.8,2-4.7,2c-2.8,0-4.8-2-4.8-4.9c0-4,3.3-7.4,7.3-7.4c2.2,0,3.6,1.1,3.6,2.6c0,2.1-2.7,3.7-7.6,4
		C151.6,19.1,151.6,19.1,151.6,19.1z M156.7,14.3c0-0.8-0.5-1.4-1.2-1.4c-1.7,0-3.5,2.1-3.8,5.5C154.8,18.4,156.7,16.4,156.7,14.3z"
		/>
	<path d="M171.8,20.5c-0.2,0.9-0.3,1.6-0.3,2c0,0.5,0.3,0.9,0.7,0.9c0.6,0,1.2-0.8,1.7-2.3c0.2-0.5,0.2-0.8,0.5-0.8
		c0.1,0,0.2,0.1,0.2,0.3c0,0.2-0.1,0.8-0.5,1.6c-0.7,1.7-1.8,2.5-3.5,2.5c-1.4,0-2.3-0.9-2.3-2.5c0-0.6,0.2-1.2,0.3-2L170.9,9
		c0.1-0.4,0.1-0.6,0.1-0.8c0-1-1.3-0.9-1.3-1.3c0-0.5,1.8-0.1,5.2-1.3L171.8,20.5z"/>
	<path d="M187.9,17.7c0,3.8-3.1,7-7.1,7c-3.2,0-5.4-2.2-5.4-5.3c0-2.3,1.2-4.4,3.3-5.8c1.2-0.8,2.5-1.2,3.8-1.2
		C185.7,12.4,187.9,14.6,187.9,17.7z M182.7,13c-0.9,0-1.8,0.6-2.5,1.8c-0.9,1.6-1.6,4.1-1.6,6.2c0,2,0.8,3.1,2.1,3.1
		c1,0,1.8-0.6,2.5-1.9c0.9-1.6,1.5-4.1,1.5-6.2C184.7,14,184.1,13,182.7,13z"/>
	<path d="M202.1,17.7c0,3.8-3.1,7-7.1,7c-3.2,0-5.4-2.2-5.4-5.3c0-2.3,1.2-4.4,3.3-5.8c1.2-0.8,2.5-1.2,3.8-1.2
		C199.9,12.4,202.1,14.6,202.1,17.7z M196.9,13c-0.9,0-1.8,0.6-2.5,1.8c-0.9,1.6-1.6,4.1-1.6,6.2c0,2,0.8,3.1,2.1,3.1
		c1,0,1.8-0.6,2.5-1.9c0.9-1.6,1.5-4.1,1.5-6.2C198.9,14,198.3,13,196.9,13z"/>
	<path d="M206.6,8.2c0-0.9-1.3-0.9-1.3-1.2c0-0.5,1.9-0.1,5.1-1.3l-2.6,12.1c1.5-3.5,3.7-5.3,5.6-5.3c1.3,0,2.3,0.9,2.3,2.1
		c0,1.8-2.3,3.7-6.4,4c1.4,0.1,2.1,0.5,2.9,1.6c1,1.2,1.2,2.4,2,2.4c1,0,1.2-2.1,1.6-2.1c0.1,0,0.2,0.1,0.2,0.2
		c0,0.2-0.2,1.1-0.9,2.2c-0.7,1.2-1.6,1.8-2.5,1.8c-0.7,0-1.4-0.3-1.9-1c-0.8-0.9-0.9-2-1.2-3c-0.3-1.1-0.8-1.6-1.7-1.7
		c-0.5,1.2-0.9,3.1-1.5,5.8c-0.5-0.3-1.1-0.4-1.6-0.4c-0.5,0-1,0.2-1.6,0.5L206.5,9C206.5,8.7,206.6,8.4,206.6,8.2z M208,18.3
		c2.9,0,4.7-1.4,4.7-2.9c0-0.7-0.5-1.2-1.1-1.2C210.4,14.2,209.1,15.6,208,18.3C208,18.3,208,18.3,208,18.3z"/>
</svg></span></h3></header>
								<div data-expandsection="product-suggestion" class="">
								<div class="product-suggestion-slider" data-slides-to-show="3">
									<?php for($i = 0; $i<7;$i++){ ?>
									<div class="one-slide">
										<div class="product-thumbnail">
											<img class="img-responsive" src="templates/images/retail/product-detail/product-suggestion<?php echo 1+$i%4 ?>.jpg" alt="item">
										</div>
										<div class="product-details">
		...
		<!--END COMPLETE THE LOOK SECTION -->
		

		<!-- START POWDER ROOM SECTION-->
		<section id="powder-room" class="section">
			<div class="container-fluid section-container">
				<div class="section-content no-border">
					<div class="row">
						<div class="col-xs-12">
							<div class="title">
								<h3>Stories from the Powder Room</h3>
								<div class="icon">
	...
	<path fill="#FFFFFF" d="M44.1,99.4c0-3.9-2.6-6.4-6.6-6.4h-7.7v12.8h7.7C41.9,105.8,44.1,103.6,44.1,99.4 M37.5,104.4h-6.2v-10h6.2
		...
		<!-- END POWDER ROOM SECTION-->

		<!--START FOOTER PROMO SECTION -->
		<div class="section footer-promo-section bg-dark-stripes">
			<div class="container-fluid section-container">
				<div class="section-content no-border">
					<div class="row">
						<div class="col-sm-5">
							<div class="inner-wrap">
								<img class="img-responsive" src="templates/images/retail/product-detail/learn-more-about-milli.jpg" alt="banner">
							</div>
						</div>
						<div class="col-sm-7">
							<div class="inner-wrap">
								<h3>Learn more about Milli</h3>
								...
								<br/>
								<br/>
								<a href="#" class="btn call-to-action small-width">Milli brand page</a>
							</div>
						</div>
					</div>
				</div>
