...
var bathroomHappiness = {
  ...
  waterTherapy: function(){
    ...
    var video = $('#banner .play-full-video').data('video');
    if(video){
      var player_container = 'water-therapy-full-video';
      var vars = {
        showinfo: 0,
      ...
      bannerVideo.init({
        ...
        loop: false,
        onReady: function(){  
          if($('#banner .banner').hasClass('playing') && !deviceMobile){
    ...
    $('#banner .play-full-video').on('click', function(){
      ...
      if($(this).hasClass('playing')){
        ...
        playerManager.pause(player_container);
         ...
         $('#full-video-popup').removeClass('hide mfp-hide');
    ...
    $('.submenu button').on('click', function(){
      ...
      var animateToPlay = function(){
        topPosition = parseInt($('#intro .video-wrap').offset().top - 50);
        if(!deviceMobile){
          var player_container = 'water-therapy-'+section+'-video';
      ...
      if($('#banner .banner').hasClass('playing')){
        $('#banner .stop-full-video').trigger('click');        
        setTimeout(function(){
          animateToPlay();
        },1000);
      }else{
    ...
    $(window).on('resize', function(){
      ...
      if(windowWidth < 768){
        ...
        $('#shower-technology .shower-technology-cards, #shower-technology .shower-technology-description .shower-technology-flip, #shower-technology .shower-technology-description .back').height('');
