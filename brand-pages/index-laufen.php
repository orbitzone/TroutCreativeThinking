...
<!--[if gt IE 8]><!--> <html class="no-js" lang="en"> <!--<![endif]-->
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="css/brand-pages/laufen.css" />
  </head>
  <body class="brand-pages">
    <div class="ocmain-wrapper">
      ...
      <?php include "templates/brand-pages/laufen.php" ?>  
    ...
    <script type="text/javascript" src="javascript/brand-pages/laufen.js"></script>
  </body>
</html>